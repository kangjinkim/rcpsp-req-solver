...
def solve_id(gencfg, ccfg, id):
    ...
    for ig_id in ig_ids:
        ...
        #print(f"preds['req2_tidx_cvalues']:{preds['req2_tidx_cvalues']}")
        #print(f"---- ----")
...
def write_id(gencfg, ccfg, idcfg):
...
if __name__ == "__main__":
    ...
    for idx, id in enumerate(gencfg["igs"].keys()):
        ...
        idcfg = solve_id(gencfg, ccfg, id)
        sol["igs"][id] = write_id(gencfg, ccfg, idcfg)
    ...
    with open(sol_file + f"_req_sol.json", 'w') as f:
